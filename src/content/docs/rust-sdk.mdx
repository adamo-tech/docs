...
cargo add adamo --features audio    # Opus microphone streaming (implies video)
```
...
pub struct AudioOptions {
    pub source_type: String,   // "auto" | "alsa" | "pulse" | "pipeline" | "test"
    pub device: Option<String>,   // ALSA/Pulse device, e.g. "plughw:1,0"
